...
- `chunk_frames` defaults to 32 when letterboxing and 8 otherwise: a chunk should stay a few megabytes, and at 256 that is 49 files per exam instead of 160 for 2.6% less space. The file count is the point — the tree gets copied to a GPU host.
